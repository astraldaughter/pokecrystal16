...
TropikoekaFrontpic:    INCBIN "gfx/pokemon/tropikoeka/front.animated.2bpp.lz"
...
KelpestaryFrontpic:   INCBIN "gfx/pokemon/kelpestary/front.animated.2bpp.lz"
...
AxecutorFrontpic:   INCBIN "gfx/pokemon/axecutor/front.animated.2bpp.lz"
...
HarlickinFrontpic:       INCBIN "gfx/pokemon/harlickin/front.animated.2bpp.lz"
MewtwoFrontpic:      INCBIN "gfx/pokemon/mewtwo/front.animated.2bpp.lz"
BambizierFrontpic:      INCBIN "gfx/pokemon/bambizier/front.animated.2bpp.lz"
...
RollabyeFrontpic:     INCBIN "gfx/pokemon/rollabye/front.animated.2bpp.lz"
SlowbroFrontpic:     INCBIN "gfx/pokemon/slowbro/front.animated.2bpp.lz"
YogsomothFrontpic:  INCBIN "gfx/pokemon/yogsomoth/front.animated.2bpp.lz"
...
JerboxerFrontpic:      INCBIN "gfx/pokemon/jerboxer/front.animated.2bpp.lz"
...
ApocarocFrontpic:    INCBIN "gfx/pokemon/apocaroc/front.animated.2bpp.lz"
MeowtletFrontpic:   INCBIN "gfx/pokemon/meowtlet/front.animated.2bpp.lz"
...
BambudFrontpic:    INCBIN "gfx/pokemon/bambud/front.animated.2bpp.lz"
...
LocholtFrontpic:   INCBIN "gfx/pokemon/locholt/front.animated.2bpp.lz"
...
KnapplithFrontpic:    INCBIN "gfx/pokemon/knapplith/front.animated.2bpp.lz"
...
BoingooseFrontpic:   INCBIN "gfx/pokemon/boingoose/front.animated.2bpp.lz"
...
FrondodoFrontpic:     INCBIN "gfx/pokemon/frondodo/front.animated.2bpp.lz"
...
GiggilickFrontpic:       INCBIN "gfx/pokemon/giggilick/front.animated.2bpp.lz"
SudowoodoFrontpic:   INCBIN "gfx/pokemon/sudowoodo/front.animated.2bpp.lz"
JaboaFrontpic:     INCBIN "gfx/pokemon/jaboa/front.animated.2bpp.lz"
...
RolliathFrontpic:     INCBIN "gfx/pokemon/rolliath/front.animated.2bpp.lz"
ChampionPic:         INCBIN "gfx/trainers/champion.2bpp.lz"
ShootainerFrontpic:     INCBIN "gfx/pokemon/shootainer/front.animated.2bpp.lz"
MagikarpFrontpic:    INCBIN "gfx/pokemon/magikarp/front.animated.2bpp.lz"
KindlantFrontpic:  INCBIN "gfx/pokemon/kindlant/front.animated.2bpp.lz"
...
TectocFrontpic:    INCBIN "gfx/pokemon/tectoc/front.animated.2bpp.lz"
...
SockitFrontpic:   INCBIN "gfx/pokemon/sockit/front.animated.2bpp.lz"
PebbluntFrontpic:    INCBIN "gfx/pokemon/pebblunt/front.animated.2bpp.lz"
SpreaselFrontpic:      INCBIN "gfx/pokemon/spreasel/front.animated.2bpp.lz"
...
FoalakeFrontpic:    INCBIN "gfx/pokemon/foalake/front.animated.2bpp.lz"
...
YogsomothBackpic:   INCBIN "gfx/pokemon/yogsomoth/back.2bpp.lz"
...
TropikoekaBackpic:     INCBIN "gfx/pokemon/tropikoeka/back.2bpp.lz"
...
MeowtletBackpic:    INCBIN "gfx/pokemon/meowtlet/back.2bpp.lz"
...
TectocBackpic:     INCBIN "gfx/pokemon/tectoc/back.2bpp.lz"
...
SockitBackpic:    INCBIN "gfx/pokemon/sockit/back.2bpp.lz"
...
KiweeFrontpic:   INCBIN "gfx/pokemon/kiwee/front.animated.2bpp.lz"
...
SpreaselBackpic:       INCBIN "gfx/pokemon/spreasel/back.2bpp.lz"
...
AxecutorBackpic:    INCBIN "gfx/pokemon/axecutor/back.2bpp.lz"
...
KnapplithBackpic:     INCBIN "gfx/pokemon/knapplith/back.2bpp.lz"
...
JerboxerBackpic:       INCBIN "gfx/pokemon/jerboxer/back.2bpp.lz"
...
ApocarocBackpic:     INCBIN "gfx/pokemon/apocaroc/back.2bpp.lz"
...
KelpestaryBackpic:    INCBIN "gfx/pokemon/kelpestary/back.2bpp.lz"
...
LocholtBackpic:    INCBIN "gfx/pokemon/locholt/back.2bpp.lz"
...
BambudBackpic:     INCBIN "gfx/pokemon/bambud/back.2bpp.lz"
VulpixBackpic:       INCBIN "gfx/pokemon/vulpix/back.2bpp.lz"
GiggilickBackpic:        INCBIN "gfx/pokemon/giggilick/back.2bpp.lz"
...
JaboaBackpic:      INCBIN "gfx/pokemon/jaboa/back.2bpp.lz"
...
FrondodoBackpic:      INCBIN "gfx/pokemon/frondodo/back.2bpp.lz"
...
RollabyeBackpic:      INCBIN "gfx/pokemon/rollabye/back.2bpp.lz"
...
PebbluntBackpic:     INCBIN "gfx/pokemon/pebblunt/back.2bpp.lz"
...
RolliathBackpic:      INCBIN "gfx/pokemon/rolliath/back.2bpp.lz"
...
PupothFrontpic:     INCBIN "gfx/pokemon/pupoth/front.animated.2bpp.lz"
...
MigrubFrontpic:    INCBIN "gfx/pokemon/migrub/front.animated.2bpp.lz"
...
ShootainerBackpic:      INCBIN "gfx/pokemon/shootainer/back.2bpp.lz"
...
KindlantBackpic:   INCBIN "gfx/pokemon/kindlant/back.2bpp.lz"
...
KiweeBackpic:    INCBIN "gfx/pokemon/kiwee/back.2bpp.lz"
...
BoingooseBackpic:    INCBIN "gfx/pokemon/boingoose/back.2bpp.lz"
StaryuBackpic:       INCBIN "gfx/pokemon/staryu/back.2bpp.lz"
MrMimeBackpic:       INCBIN "gfx/pokemon/mr__mime/back.2bpp.lz"
MigrubBackpic:     INCBIN "gfx/pokemon/migrub/back.2bpp.lz"
...
HarlickinBackpic:        INCBIN "gfx/pokemon/harlickin/back.2bpp.lz"
...
BambizierBackpic:       INCBIN "gfx/pokemon/bambizier/back.2bpp.lz"
...
PupothBackpic:      INCBIN "gfx/pokemon/pupoth/back.2bpp.lz"
...
FoalakeBackpic:     INCBIN "gfx/pokemon/foalake/back.2bpp.lz"
...
INCBIN "gfx/pokemon/foalake/back.2bpp.lz"
