	...
	const ROUTE28STEELWINGHOUSE_BAMBIZIER
...
CelebritysBambizier:
	opentext
	writetext CelebritysBambizierText
	cry BAMBIZIER
	waitbutton
	closetext
	end
...
CelebritysBambizierText:
	text "BAMBIZIER: Feero!"
	done
...
Route28SteelWingHouse_MapEvents:
	...
	object_event  6,  5, SPRITE_MOLTRES, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, CelebritysBambizier, -1
