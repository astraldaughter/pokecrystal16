...
; Johto story events
	...
	const EVENT_GOT_BERRY_FROM_ROUTE_52_HOUSE
	...
	const EVENT_GOT_MYSTIC_WATER_IN_CAMPANULA
...
; Johto hidden items
	...
	const EVENT_ROUTE_52_HIDDEN_POTION
	...
	const EVENT_ROUTE_61_HIDDEN_PP_UP
	const EVENT_EDELWEISS_CITY_HIDDEN_HYPER_POTION
...
; Kanto hidden items
	const EVENT_FOOTHILL_CAVES_HIDDEN_POTION
...
; Decorations
	...
	const EVENT_DECO_JABOA_DOLL
	const EVENT_DECO_SURFING_JABOA_DOLL
	const EVENT_DECO_CLEFAIRY_DOLL
	const EVENT_DECO_JIGGLYPUFF_DOLL
	const EVENT_DECO_KIWEE_DOLL
	const EVENT_DECO_KINDLANT_DOLL
	const EVENT_DECO_FOALAKE_DOLL
...
; More Johto story events
	...
	const EVENT_LEARNED_BAMBUD_TAIL
...
; Johto itemballs
	...
	const EVENT_FOOTHILL_CAVES_POKE_BALL
	const EVENT_EDELWEISS_CITY_RARE_CANDY
	...
	const EVENT_ROUTE_61_NUGGET
	const EVENT_ROUTE_61_REVIVE
	const EVENT_ROUTE_61_ELIXER
	const EVENT_ROUTE_61_MAX_POTION
	const EVENT_ROUTE_53_X_SPEED
; Johto people
	const EVENT_RIVAL_NIVALE_TOWN
	...
	const EVENT_EDELWEISS_CITY_EARL
	...
	const EVENT_ROUTE_53_HIKER
	const EVENT_RIVAL_EDELWEISS_TOWN
...
; New to Crystal
	...
	const EVENT_EDELWEISS_RUINS_OUTSIDE_TOURIST_FISHER
	const EVENT_EDELWEISS_RUINS_OUTSIDE_TOURIST_YOUNGSTERS
