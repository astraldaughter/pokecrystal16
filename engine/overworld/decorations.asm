...
.ornaments:
	db DECO_JABOA_DOLL ; 1e
	db DECO_SURF_JABOA_DOLL ; 1f
	db DECO_CLEFAIRY_DOLL ; 20
	db DECO_JIGGLYPUFF_DOLL ; 21
	db DECO_KIWEE_DOLL ; 22
	db DECO_KINDLANT_DOLL ; 23
	db DECO_FOALAKE_DOLL ; 24
...
DecorationDesc_PosterPointers:
	...
	dbw DECO_JABOA_POSTER, DecorationDesc_JaboaPoster
...
DecorationDesc_JaboaPoster:
	jumptext .LookJaboaPosterText

.LookJaboaPosterText:
	text_far _LookJaboaPosterText
	text_end
