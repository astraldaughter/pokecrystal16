...
InitializeEventsScript:
	...
	setevent EVENT_GUIDE_GENT_VISIBLE_IN_CAMPANULA
	setevent EVENT_ELMS_AIDE_IN_VIOLET_POKEMON_CENTER
	setevent EVENT_COP_IN_ELMS_LAB
	setevent EVENT_EDELWEISS_RUINS_OUTSIDE_SCIENTIST
	...
	setevent EVENT_EDELWEISS_RUINS_OUTSIDE_TOURIST_FISHER
	setevent EVENT_EDELWEISS_RUINS_OUTSIDE_TOURIST_YOUNGSTERS
