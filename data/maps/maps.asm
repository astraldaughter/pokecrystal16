...
MapGroup_Violet:
	...
	map VioletMart, TILESET_MART, INDOOR, LANDMARK_EDELWEISS_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map VioletPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_EDELWEISS_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
