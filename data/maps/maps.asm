...
MapGroup_Blackthorn:
	...
	map Route53, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_53, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Campanula:
	...
	map Route52BerryHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_52, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
