...
; pointers to the first map of each map group
	...
	dw MapGroup_Nivale      ; 24
	dw MapGroup_Saffron     ; 25
	dw MapGroup_Campanula   ; 26
	dw MapGroup_Edelweiss	; 27
...
MapGroup_Dungeons:
	...
	map EdelweissRuinsOutside, TILESET_JOHTO, ROUTE, LANDMARK_EDELWEISS_RUINS, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map RuinsOfAlphHoOhChamber, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_EDELWEISS_RUINS, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphKabutoChamber, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_EDELWEISS_RUINS, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphOmanyteChamber, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_EDELWEISS_RUINS, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphAerodactylChamber, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_EDELWEISS_RUINS, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map EdelweissRuins1F, TILESET_RUINS_DUNGEON, DUNGEON, LANDMARK_EDELWEISS_RUINS, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphResearchCenter, TILESET_FACILITY, INDOOR, LANDMARK_EDELWEISS_RUINS, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphHoOhItemRoom, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_EDELWEISS_RUINS, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphKabutoItemRoom, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_EDELWEISS_RUINS, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphOmanyteItemRoom, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_EDELWEISS_RUINS, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphAerodactylItemRoom, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_EDELWEISS_RUINS, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphHoOhWordRoom, TILESET_HO_OH_WORD_ROOM, DUNGEON, LANDMARK_EDELWEISS_RUINS, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphKabutoWordRoom, TILESET_KABUTO_WORD_ROOM, DUNGEON, LANDMARK_EDELWEISS_RUINS, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphOmanyteWordRoom, TILESET_OMANYTE_WORD_ROOM, DUNGEON, LANDMARK_EDELWEISS_RUINS, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphAerodactylWordRoom, TILESET_RUINS_DUNGEON, DUNGEON, LANDMARK_EDELWEISS_RUINS, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map FoothillCaves, TILESET_CAVE, CAVE, LANDMARK_FOOTHILL_CAVES, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Violet:
	...
	map VioletGym, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_EDELWEISS_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map EarlsPokemonAcademy, TILESET_LAB, INDOOR, LANDMARK_EDELWEISS_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Nivale:
	table_width MAP_LENGTH, MapGroup_Nivale
	...
	map PlayersHouse2F, TILESET_PLAYERS_ROOM, INDOOR, LANDMARK_NIVALE_TOWN, MUSIC_LAVA_REEF_ZONE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route51Route53Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_51, MUSIC_ROUTE_29, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Campanula:
	table_width MAP_LENGTH, MapGroup_Campanula
	map Route52, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_52, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map CampanulaMart, TILESET_MART, INDOOR, LANDMARK_CAMPANULA_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CampanulaPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_CAMPANULA_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CampanulaGymSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_CAMPANULA_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CampanulaEvolutionSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_CAMPANULA_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MrPokemonsHouse, TILESET_FACILITY, INDOOR, LANDMARK_ROUTE_52, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route31VioletGate, TILESET_GATE, GATE, LANDMARK_ROUTE_31, MUSIC_ROUTE_30, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_CAMPANULA_MAPS

MapGroup_Edelweiss:
	table_width MAP_LENGTH, MapGroup_Edelweiss
	map Route53, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_53, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route53EdelweissGate, TILESET_GATE, GATE, LANDMARK_ROUTE_53, MUSIC_ROUTE_30, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map EdelweissCity, TILESET_JOHTO, TOWN, LANDMARK_EDELWEISS_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND	
	map EdelweissCraftShop, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_EDELWEISS_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map EdelweissMart, TILESET_MART, INDOOR, LANDMARK_EDELWEISS_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map EdelweissPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_EDELWEISS_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route61, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_61, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map EdelweissGymLeaderSpeechHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_EDELWEISS_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map EdelweissSpeedupHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_EDELWEISS_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_EDELWEISS_MAPS