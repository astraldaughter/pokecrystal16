...
.hi_bi_pi: db CLEFFA, WEEDLE, PIKACHU, CLEFABLE, ROLLABYE, BOINGOOSE, PICHU, CLEFAIRY, KINDLANT, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, -1
...
.ra:       db RAIKOU, RAICHU, CHANSEY, BAMBUD, LAPRAS, VILEPLUME, LANTURN, -1
