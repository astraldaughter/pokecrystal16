...
; ANIM_OBJ_POWER_GEM
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_B9, BATTLEANIMFUNC_POWER_GEM, PAL_BATTLE_OB_GRAY, ANIM_GFX_SHINE
; ANIM_OBJ_ICICLE_CRASH
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_1A, BATTLEANIMFUNC_DROP, PAL_BATTLE_OB_BLUE, ANIM_GFX_ICE
; ANIM_OBJ_HAIL
