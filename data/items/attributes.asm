...
; POKE_BALL
	item_attribute 200, HELD_ATTACK_UP, 0, CANT_SELECT, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; TOWN_MAP
...
; MIRAGE_MAIL
	item_attribute 50, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; HEAT_ROCK
	item_attribute 4000, HELD_HEAT_ROCK, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; DAMP_ROCK
	item_attribute 4000, HELD_DAMP_ROCK, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SMOOTH_ROCK
	item_attribute 4000, HELD_SMOOTH_ROCK, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ICY_ROCK
	item_attribute 4000, HELD_ICY_ROCK, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
