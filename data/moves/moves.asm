...
Moves1:
	...
	move EFFECT_DOUBLE_HIT,         30, NORMAL,   PHYSICAL,  95, 10,   0 ;DOUBLESLAP
	...
	move EFFECT_BURN_HIT,           80, FIRE,     PHYSICAL, 100, 15,  10 ;FIRE_PUNCH
	move EFFECT_FREEZE_HIT,         80, ICE,      PHYSICAL, 100, 15,  10 ;ICE_PUNCH
	move EFFECT_PARALYZE_HIT,       80, ELECTRIC, PHYSICAL, 100, 15,  10 ;THUNDERPUNCH
	...
	move EFFECT_NORMAL_HIT,         80, FLYING,   SPECIAL,  100, 10,   0 ;RAZOR_WIND
	move EFFECT_ATTACK_UP_2,         0, NORMAL,   STATUS,   100, 30,   0 ;SWORDS_DANCE
	move EFFECT_NORMAL_HIT,         60, NORMAL,   PHYSICAL,  95, 30,   0 ;CUT
	...
	move EFFECT_FLY,		        100, FLYING,  PHYSICAL, 100, 15,   0 ;FLY
	...
	move EFFECT_SP_DEF_DOWN_HIT,    40, POISON,   SPECIAL,  100, 30,  30 ;ACID
	...
	move EFFECT_RECOIL_HIT,        100, FIGHTING, PHYSICAL,  80, 25,   0 ;SUBMISSION
	...
	move EFFECT_ATTACK_UP_HIT,      70, FIGHTING, PHYSICAL,  90, 15,  20 ;STRENGTH
	...
	move EFFECT_TRAP_TARGET,        35, WATER,    PHYSICAL,  85, 10,   0 ;CLAMP
	...
	move EFFECT_ACCURACY_DOWN_HIT,  20, ELECTRIC, SPECIAL,  100, 20, 100 ;FLASH
	...
	move EFFECT_FLINCH_HIT,         80, ROCK,     PHYSICAL,  95, 10,  30 ;ROCK_SLIDE
	...
	move EFFECT_FURY_CUTTER,        30, BUG,      PHYSICAL,  95, 20,   0 ;FURY_CUTTER
	...
	move EFFECT_PARALYZE_HIT,       75, DRAGON,   SPECIAL,  100, 20,  30 ;DRAGONBREATH
	...
	move EFFECT_RAPID_SPIN,         40, NORMAL,   PHYSICAL, 100, 40,   0 ;RAPID_SPIN
...
Moves2:
	...
	move EFFECT_SP_ATK_DOWN_HIT,	80, FAIRY,	SPECIAL, 	100, 15,  30 ;MOONBLAST
	...
	move EFFECT_ALWAYS_HIT,			60, FLYING,	PHYSICAL,	100, 10,   0 ;AERIAL_ACE
	move EFFECT_SP_ATK_UP_2,		 0, DARK,	STATUS,		100, 20,   0 ;NASTY_PLOT
	move EFFECT_NORMAL_HIT,			80, ROCK,	SPECIAL,	100, 20,   0 ;POWER_GEM
	move EFFECT_SP_ATK_UP_HIT,		50, ELECTRIC,	SPECIAL, 90, 10,   100 ;CHARGE_BEAM
	move EFFECT_FLINCH_HIT,		    60, FAIRY,	PHYSICAL,   100, 25,  0 ;HEART_BREAK
	move EFFECT_ACCURACY_UP,		 0, NORMAL,	STATUS,		100, 20,  0 ;ECHOLOCATION
	move EFFECT_EVASION_DOWN_HIT,	90, WATER,	SPECIAL,	90,  10, 20 ; UNDERTOW
	move EFFECT_FLINCH_HIT,			80, DARK,	SPECIAL,	100, 15, 20 ; DARK_PULSE
	move EFFECT_FLINCH_HIT,			80, STEEL,	SPECIAL,	100, 15, 30 ; IRON_HEAD
	move EFFECT_GUST,				90, NORMAL, PHYSICAL,  	 90, 10,  0 ; SPRINGSHOT
	...
	move EFFECT_ALWAYS_HIT,			60, STEEL,	SPECIAL,	100, 20,  0 ; MAGNET_PULSE
	...
	move EFFECT_TRAP_TARGET,        35, FAIRY,    SPECIAL,   85, 15,   0 ; FAIRY_RING
	move EFFECT_LEECH_HIT,			60, FAIRY,  SPECIAL,	100, 10, 0 ; DRAININGKISS
	move EFFECT_MULTI_HIT,			15, FAIRY, PHYSICAL,	 85, 15, 0 ; BIBBIDI_BOP
	...
	move EFFECT_SP_ATK_DOWN_2,		 0, DRAGON, STATUS,	   100,  20, 0 ; DRAGON_ROAR
	...
	move EFFECT_JUMP_KICK,		   100, ROCK,	PHYSICAL,	90,  10, 0 ; STONE_CRASH
	move EFFECT_HAIL, 				 0, ICE,	STATUS,	   100,  10, 0 ; HAIL
	move EFFECT_RAMPAGE,		   120, ELECTRIC, PHYSICAL, 100, 15, 0 ; WILD_THUNDER
	move EFFECT_CONFUSE,			 0, POISON, STATUS,    100,  10, 0 ; INEBRIATE
.IndirectEnd::
